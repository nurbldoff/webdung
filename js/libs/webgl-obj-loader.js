    ...
    */
    ...
    for( var i=0; i<lines.length; i++ ){
      ...
      // if this is a vertex normal
        ...
        vertNormals.push( parseFloat(line[ 0 ]) );
        vertNormals.push( parseFloat(line[ 1 ]) );
        vertNormals.push( parseFloat(line[ 2 ]) );
      }
      // if this is a texture
      else if( lines[ i ].startsWith( 'vt' ) ){
        line = lines[ i ].slice( 3 ).split( " " )
        textures.push( parseFloat(line[ 0 ]) );
        textures.push( parseFloat(line[ 1 ]) );
      }
      // if this is a face
